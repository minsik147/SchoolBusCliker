...
public class BusReservation_H_BusStop extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_bus_reservation_h_bus_stop);
        ...
        bt_end.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                if (isSelect == false)
                {
                    for(int i=1; i<(int_busStopCount - 1); i++)
                    {
...
//        });
        ...
        bt_OK.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(BusReservation_H_BusStop.this);
